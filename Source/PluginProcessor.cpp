    ...
    SimpleEQAudioProcessor::createParameterLayout()
{
        ...
        layout.add(std::make_unique<juce::AudioParameterFloat>(juce::ParameterID("Peak Gain", 1),
                                                               "Peak Gain",
                                                               juce::NormalisableRange<float>(-24.f, 25.f, 0.5f, 1.f),
                                                               0.f));
        ...
        layout.add(std::make_unique<juce::AudioParameterChoice>(juce::ParameterID("LowCut Slope", 1), "LowCut Slop", stringArray, 0));
        layout.add(std::make_unique<juce::AudioParameterChoice>(juce::ParameterID("HighCut Slope", 1), "LowCut Slop", stringArray, 0));
...
ChainSettings getChainSettings(juce::AudioProcessorValueTreeState& apvts){
    ...
    // We don't use this because it returns a normalized value when we want real-world values
